...
# II --- Load data
df_pd = pd.read_parquet('pluckingpo_estimates_pf' + file_suffix_fcast + '.parquet')  # not dns
...
def plot_linechart(
    ...
    fig.write_image('Output/PluckingPO_NotDNS_ObsCeiling_' + output_suffix + file_suffix_fcast + '.png',
                    height=768, width=1366)
    fig.write_html('Output/PluckingPO_NotDNS_ObsCeiling_' + output_suffix + file_suffix_fcast + '.html')
    return fig
...
fig_gdp = plot_linechart(data=df_pd,
                         ...
                         dash_styles=dash1,
                         y_axis_title='ppt',
                         main_title='Real GDP: Observed and Ceiling (Alternative Algorithm)',
                         output_suffix='GDP',
...
fig_lab = plot_linechart(data=df_pd,
                         ...
                         dash_styles=dash1,
                         y_axis_title='ppt',
                         main_title='Labour: Observed and Ceiling (Alternative Algorithm)',
...
fig_cap = plot_linechart(data=df_pd,
                         ...
                         dash_styles=dash1,
                         y_axis_title='ppt',
                         main_title='Capital: Observed and Ceiling (Alternative Algorithm)',
...
fig_tfp = plot_linechart(data=df_pd,
                         ...
                         dash_styles=dash1,
                         y_axis_title='ppt',
                         main_title='TFP: Observed and Ceiling (Alternative Algorithm)',
                         output_suffix='TFP',
                         use_forecast_choice=use_forecast)
fig_og = plot_linechart(data=df_og,
                        ...
                        main_title='Output Gap: Boom-Bust and Plucking (Alternative Algorithm)',
                        output_suffix='OG',
                        use_forecast_choice=use_forecast)
fig_og_norm = plot_linechart(data=df_og,
                             ...
                             dash_styles=dash3,
                             y_axis_title='Index',
                             main_title='Normalised Output Gap: Boom-Bust and Plucking (Alternative Algorithm)',
...
for i in suffix_figs:
    telsendimg(conf=tel_config,
               path='Output/PluckingPO_NotDNS_ObsCeiling_' + i + file_suffix_fcast + '.png',
               cap=i + ' (observed and ceiling)')

# IV --- Notify
telsendmsg(conf=tel_config,
           msg='pluckingpo_plot_ceiling_po_og_notdns: COMPLETED')
