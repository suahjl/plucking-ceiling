...
fig_gdp = plot_linechart(data=df_pd,
                         cols=['gdp15', 'gdp15_ceiling', 'gdp15_ceiling_lb'],
                         nice_names=['Observed Real GDP', 'Output Ceiling UB', 'Output Ceiling LB'],
                         colours=['crimson', 'black', 'black'],
                         dash_styles=['solid', 'longdash', 'longdash'],
                         y_axis_title='ppt',
                         main_title='Real GDP: Observed and Ceiling',
                         output_suffix='GDP',
                         fcast_start=T_forecast_start)
fig_lab = plot_linechart(data=df_pd,
                         cols=['labour_observed', 'labour_ceiling', 'labour_ceiling_lb'],
                         nice_names=['Observed Labour', 'Labour Ceiling UB', 'Labour Ceiling LB'],
                         colours=['crimson', 'black', 'black'],
                         dash_styles=['solid', 'longdash', 'longdash'],
                         y_axis_title='ppt',
...
fig_cap = plot_linechart(data=df_pd,
                         cols=['capital_observed', 'capital_ceiling', 'capital_ceiling_lb'],
                         nice_names=['Observed Labour', 'Capital Ceiling UB', 'Capital Ceiling LB'],
                         colours=['crimson', 'black', 'black'],
                         dash_styles=['solid', 'longdash', 'longdash'],
                         y_axis_title='ppt',
...
fig_tfp = plot_linechart(data=df_pd,
                         cols=['tfp_observed', 'tfp_ceiling', 'tfp_ceiling_lb'],
                         nice_names=['Observed TFP', 'TFP Ceiling UB', 'TFP Ceiling LB'],
                         colours=['crimson', 'black', 'black'],
                         dash_styles=['solid', 'longdash', 'longdash'],
                         y_axis_title='ppt',
...
fig_og = plot_linechart(data=df_og,
                        cols=['pluck_og', 'pluck_og_lb', 'boom_bust_og', 'ref'],
                        nice_names=['Plucking UB', 'Plucking LB', 'Original', 'Reference (Y=0)'],
                        colours=['darkblue', 'darkblue', 'lightcoral', 'black'],
                        dash_styles=['solid', 'solid', 'longdash', 'dash'],
                        y_axis_title='% Potential Output',
                        main_title='Output Gap: Original and Plucking',
                        output_suffix='OG',
                        fcast_start=T_forecast_start)
fig_og_norm = plot_linechart(data=df_og,
                             cols=['pluck_og_norm', 'boom_bust_og_norm'],
                             nice_names=['Plucking UB', 'Original'],
                             colours=['darkblue', 'lightcoral'],
                             dash_styles=['solid', 'solid'],
                             y_axis_title='Index',
                             main_title='Normalised Output Gap: Original and Plucking',
