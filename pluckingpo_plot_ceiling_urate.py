...
# II --- Load data
df = pd.read_parquet('pluckingpo_dns_urate_estimates' + file_suffix_fcast + '.parquet')
...
fig_gdp = plot_linechart(data=df,
                         ...
                         dash_styles=dash1,
                         y_axis_title='ppt',
                         main_title='U-Rate: Observed and Floor',
                         output_suffix='URate',
...
telsendmsg(conf=tel_config,
           msg='pluckingpo_plot_ceiling_urate: COMPLETED')
