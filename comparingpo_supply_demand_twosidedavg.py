...
pil_img2pdf(list_images=seq_output,
            img_path='Output/',
            extension='png',
            pdf_name='ComparingPO_SupplyDemand_AllCharts_TwoSidedAvg')
telsendfiles(conf=tel_config,
             path='Output/ComparingPO_SupplyDemand_AllCharts_TwoSidedAvg.pdf',
             cap='All charts on comparing the responses of PO estimates to supply and demand shocks')

# XX --- Notify
telsendmsg(conf=tel_config,
           msg='comparingpo_supply_demand_twosidedavg: COMPLETED')
